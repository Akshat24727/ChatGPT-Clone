...
contract GPTMembership is ERC721 {
	...
	string public MY_CONTRACT = "Akshat Kumar Srivastava";
	...
	function mint(uint256 _membershipId, uint256 _cost, string memory _expireDate) public payable {
		require(_membershipId != );
		require(_membershipId  );
	}
}
...
// 	string public MY_CONTRACT = "Akshat Srivastava";
...
// 	function mint(uint256 _membershipId,
// 	 address _user, string memory _expiredDate) 
// 	public payable
// 	{
// 		require(_membershipId != 0);
// 		require(_membershipId <= membershipTypes);
	
// 		require(msg.value >= memberships[_membershipId].cost,
...
// 	function getMemberships(uint256 _membershipId) 
// 	public view returns(Membership memory){
// 		return memberships[_membershipId];
// 	}
// 	function getMembershipsTaken(uint256 _membershipId) 
